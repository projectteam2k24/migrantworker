...
class WorkerChatScreen extends StatefulWidget {
  const WorkerChatScreen({Key? key}) : super(key: key);

  @override
  WorkerChatScreenState createState() => WorkerChatScreenState();
}

class WorkerChatScreenState extends State<WorkerChatScreen> {
  ...
  Future<void> sendMessage() async {
    if (_messageController.text.isNotEmpty && recipient != null) {
  ...
  Widget buildMessageList() {
    ...
    return StreamBuilder<QuerySnapshot>(
      stream: messagesCollection
          .where('senderId', whereIn: [currentUserId, recipient])
          .where('recipientId', whereIn: [currentUserId, recipient])
