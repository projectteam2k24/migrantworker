...
class EditJobProviderProfile extends StatefulWidget {
  const EditJobProviderProfile({super.key});

  @override
  State<EditJobProviderProfile> createState() => _EditJobProviderProfileState();
}

class _EditJobProviderProfileState extends State<EditJobProviderProfile> {
